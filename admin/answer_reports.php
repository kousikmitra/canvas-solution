    ...
    <div class="container-fluid" id="main">
        <div class="row row-offcanvas row-offcanvas-left">
                ...
                <ul class="nav flex-column pl-1">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="list-unstyled flex-column pl-3 collapse" id="submenu1" aria-expanded="false">
                            ...
                            <li class="nav-item"><a class="nav-link" href="./answer_reposts.php">Answer Reports</a></li>
                        </ul>
                    </li>
            ...
            <p class="hidden-md-up">
                ...
                <?php
                $sql = "SELECT COUNT(answer_id) as 'TOTAL_ANSWERS' FROM answer;";
                    ...
                    <div class="col-xl-3 col-lg-6 offset-3">
                        <div class="card card-inverse card-success">
                            <div class="card-block bg-success">
                                ...
                                <h6 class="text-uppercase">Answers</h6>
                                <h1 class="display-1"><?php echo $result['TOTAL_ANSWERS']; ?></h1>
                            </div>
                        </div>
                    </div>
                    <?php
                    $sql = "SELECT COUNT(id) as 'ANSWER_REPORTS' FROM report_answer;";
                    $result = $conn->query($sql)->fetch_assoc();
                    ?>
                    <div class="col-xl-3 col-lg-6">
                        <div class="card card-inverse card-danger">
                            <div class="card-block bg-danger">
                                ...
                                <h1 class="display-1"><?php echo $result['ANSWER_REPORTS']; ?></h1>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <a id="layouts"></a>
                <hr>
                <h2 class="sub-header">Reports are shown here!</h2>
                <div class="row mb-3">
                    ...
                    <div class="col-lg">
                        <div class="card card-default card-block">
                            <ul id="tabsJustified" class="nav nav-tabs nav-justified">
                                <li class="nav-item">
                                    <a class="nav-link active" href="" data-target="#tab1" data-toggle="tab">Reported Answers</a>
                                </li>
                            </ul>
                            <!--/tabs-->
                            <br>
                                        ...
                                        <div class="col-lg col-md">
                                            <div class="table-responsive">
                                                <table class="table table-striped">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $sql = "SELECT answer.question_id AS 'Q_ID', answer.answer_id AS 'A_ID', answer.user_id AS 'A_USER', answer.answer AS 'ANSWER',
                                                                answer.upvote AS 'A_UPVOTE', report_answer.id AS 'R_ID', report_answer.user_id AS 'R_USER', report_answer.report_details AS 'R_DETAILS',
                                                                report_answer.report_date AS 'R_DATE'  FROM answer, report_answer WHERE answer.answer_id = report_answer.answer_id;";
                                                        ...
                                                        if ($result->num_rows > 0) {
                                                            ...
                                                            while ($row = $result->fetch_assoc()) {
                                                                ...
                                                                <tr>
                                                                    <td><?php echo ++$i; ?></td>
                                                                    <?php
                                                                    $a_user = $conn->query("SELECT name FROM user WHERE user_id={$row['A_USER']}")->fetch_assoc()['name'];
                                                                    ...
                                                                    <td><?php echo substr($row['ANSWER'],0, 500). " ... <a href=\"../answers.php?question_id={$row['Q_ID']}\">(more)</a>"; ?></td>
                                                                    <td><?php echo $row['A_UPVOTE']; ?></td>
                                                            ...
                                                            <td>
                                                                            <a class="deleteAnswer" data="<?php echo $row['Q_ID']; ?>" href=""><i style="color:red;" class="fa fa-trash fa-1x" aria-hidden="true"></i></a>
