    ...
    <nav class="navbar navbar-fixed-top navbar-toggleable-sm navbar-inverse bg-primary mb-3">
        ...
        <div class="navbar-collapse collapse" id="collapsingNavbar">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#myAlert" data-toggle="collapse">Change Password</a>
                </li>
            </ul>
        ...
        <div class="row row-offcanvas row-offcanvas-left">
            <div class="col-md-3 col-lg-2 sidebar-offcanvas" id="sidebar" role="navigation">
                <ul class="nav flex-column pl-1">
                    ...
                    <li class="nav-item"><a class="nav-link" href="#">Banned Users</a></li>
                </ul>
            </div>
            <!--/col-->
            ...
            <p class="hidden-md-up">
                ...
                <hr>
                <br><p class="display-4">Welcome <?php echo $conn->query("SELECT username FROM admin WHERE id={$_SESSION['admin_id']}")->fetch_assoc()['username']; ?></p><br>
                <hr>
                <p class="lead hidden-xs-down">The admin section is still under process...</p>
                ...
                <div class="row mb-5">
                    ...
                    <?php
                    $sql = "SELECT COUNT(upvote_id) as 'TOTAL_UPVOTES' FROM upvote;";
                    $result = $conn->query($sql)->fetch_assoc();
                    ?>
                    <div class="col-xl-3 col-lg-6">
                        <div class="card card-inverse card-warning">
                            <div class="card-block bg-warning">
                                ...
                                <h6 class="text-uppercase">Upvotes</h6>
                                <h1 class="display-1"><?php echo $result['TOTAL_UPVOTES']; ?></h1>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row placeholders mb-3 mt-5">
                    <?php
                     $sql = "SELECT COUNT(user_id) as 'BANNED_USERS' FROM user WHERE banned IS NOT NULL;";
                     $result = $conn->query($sql)->fetch_assoc();
                    ?>
                    <div class="col-4 placeholder text-center">
                        <div class="card card-inverse card-warning">
                            <div class="card-block bg-warning">
                                <div class="rotate">
                                    <i class="fa fa-check fa-5x"></i>
                    ...
                    <div class="col-4 placeholder text-center">
                        <div class="card card-inverse card-warning">
                            <div class="card-block bg-warning">
                                ...
                                <h6 class="text-uppercase">Reported Question</h6>
                    ...
                    <div class="col-4 placeholder text-center">
                        <div class="card card-inverse card-warning">
                            <div class="card-block bg-warning">
                                ...
                                <h6 class="text-uppercase">Reported Answers</h6>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary-outline" data-dismiss="modal" onclick="document.location.href='./logout.php'">OK</button>
                </div>
            </div>
        </div>
    </div>
