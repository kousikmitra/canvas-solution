    ...
    <?php if (isset($_SESSION['user_id'])) { ?>
        ...
        <div class="container">
            <div class="">
                ...
                ?>
                <div class="row">
                    <div class="col-md-8 col-md-offset-2" style="padding: 3% 1%;"><small class="" style="float: left; padding-top: 9px;"><?php echo get_time_difference($question_date); ?></small>
                        <a href="./report.php?question_id=<?php echo $question_id; ?>" target="" style="float: right">
                            <h5 style="">Report this</h5>
                        </a>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <h1 style="font-family: 'Baloo Bhai', cursive;margin-bottom:20px"><?php echo "$question"; ?></h1>
                    </div>
                    <div class="col-md-2"></div>
                </div> <?php
                ...
                <div class="row">
                    ...
                    <div class="col-md-2"></div>
                    <div class="col-md-8">
                        <h3 style="font-family: 'Baloo Bhai', cursive;margin-bottom:50px;font-weight:200;text-align:right">Questioned By - <?php echo "<a href='profile.php?user_id=$question_user_id'>$name</a>"; ?></h3>
                    </div>
                    <div class="col-md-2"></div>
                </div>
                <?php
                ...
                if (mysqli_num_rows($result) == 0) {
                    ...
                    while ($row = mysqli_fetch_array($result) and $c < 10) {
                        ...
                        <div class="row" style="margin:50px 0px">
                            <div class="row">
                                <div class="col-md-2"></div>
                                <div class="col-md-8" style="background-color:#fff; box-shadow:2px 2px 5px grey; border-radius: 10px 10px 0px 0px;"><small class="" style="float: left; padding-top: 9px;"><?php echo get_time_difference($answer_date); ?></small>
                                    <a href="./report.php?answer_id=<?php echo $answer_id; ?>" target="" style="float: right">
                                        <h5 style="">Report this</h5>
                                    </a>
                                </div>
                                <div class="col-md-2"></div>
                            ...
                            <div class="row">
                            <div class="col-md-2"></div>
                            <div class="col-md-8" style="background-color:#fff; box-shadow:2px 2px 5px grey; padding:30px; border-radius: 0px 0px 10px 10px;">
