      ...
      <div class="container" style="max-width:80vw;">
        <div class="row" style="">
          ...
          if (!$error) {
              ?>
            <div class="col-8">
              <div class="container-fluid p-0" style="margin-top:20px; box-shadow: 0px 0px 5px 0px rgba(0,0,0,0.5);">
                <div class="rounded-circle">

                  <div class="msg-wgt-header" style="padding: 10px 5px;">
              ...
              <tr class="msg-row-container">
                <td>
                  <div class="msg-row">
                    <img src=".$photo" class="avatar rounded-circle"></div>
                    <div class="message">
...
MSG;
                  ...
                  <div class="msg-wgt-footer">
                    <textarea id="chatMsg" style="font-size: 1.6rem; padding: 10px;" class="mb-n1" data="<?php echo $_GET['sent_to']; ?>" placeholder="Type your message. Press shift + Enter to send"></textarea>
                  </div>
                </div>
                <?php
          }
