...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <div style="text-align:center"><h3 style="font-size: 250%;color:#fff">Don't have an account? <a href="signup.php" target="_blank" style="color:#fff;text-decoration:none;"><span class="glyphicon glyphicon-user"></span>Register</a></h3></div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="col-md-6" style="padding:10px;padding-bottom:0;margin:0;border:2px solid white">
        <div class="panel panel-default" style="padding:10px;margin:0;border:2px solid black">
            <div class="panel-heading" style="background-color:black;color:white"><h3>User Log In</h3></div>
            ...
            <input type="submit" value="Login" name="login" class="btn btn-md" style="background-color:black;color:white">
            </form>
            </div>
            <h4 style="font-weight:800">Forgot Your Password ? <a href="forgot_password.php" style="text-decoration:none;color:#fff;background-color:black" class="btn btn-default"> Click Here </a> To Recover Your Password</h4>
        </div>
        <div><?php
        if(isset($_GET['login_error'])){
        echo "<div class='container-fluid'><div class='row'><div style='col-md-12' style='text-align:center;color:#fff'><h4 style='text-align:center;color:#fff'>".$_GET['login_error']."</h4></div></div></div>"; } ?></div>
