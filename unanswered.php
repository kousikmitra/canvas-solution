...
<?php
    ...
    <div style="text-align:center;">
        <h1 style="font-family: 'Baloo Bhai', cursive;margin:40px">Answer Unanswered Queries</h1>
    </div>
    <div class="container">
        <div class="">
            <?php
            ...
            if(mysqli_num_rows($result)==0){
                ...
                while($row=mysqli_fetch_array($result) and $c<10){
                    ...
                    $x=mysqli_query($con,"SELECT * FROM answer WHERE question_id='$question_id'") or die(mysqli_error($con));
                    $x=mysqli_num_rows($x);
                    if($x==0){
                    $c=$c+1;
                    ?>
                    ...
                    <div class="col-md-8" style="background-color:#fff;box-shadow:20px 20px 10px grey;margin:20px 0;padding:15px;border:.1px solid grey">
                        ...
                        <div style="padding:20px">
                            <h5 style="color:#35C195;;font-weight:bold;text-align:right" ><a href='answers.php?question_id=<?php echo "$question_id" ?>'>Write An Answer</a></h5>
                        </div>
                    </div>
                    <div class="col-md-2"></div>
                    </div>
